...
import binascii, cStringIO, stat,xbmcvfs
import io
import re
import string
try:
...
try:
    if os.path.exists(xbmc.translatePath("special://home/addons/") + 'skin.Premium.mod'):
except:
    if os.path.exists(xbmcvfs.translatePath("special://home/addons/") + 'skin.Premium.mod'):
 Items=True
def platform():
