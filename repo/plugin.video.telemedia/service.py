...
try:
    os.remove(os.path.join(xbmc.translatePath("special://userdata/"),"addon_data","plugin.video.telemedia","database","db.sqlite"))
except:
    pass
try:
    shutil.rmtree(os.path.join(xbmc.translatePath("special://userdata/"),"addon_data","plugin.video.telemedia","files"))
            ...
            if f:
                ...
                while chunk > 0:
                    ...
                    try:
                        ...
                        log.warning( 'ERRRRRRRRRRRR333333:'+str(e))
                        pass
                    try:
                        ...
                        try:
                            ...
                            #log.warning( 'ERRRRRRRRRRRRR2222222:'+str(e))
                            break
                        '''
                    total += chunk
                    #time.sleep(0.001)
