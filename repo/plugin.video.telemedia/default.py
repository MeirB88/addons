...
class OverlayText:
    def __init__(self):
        ...
        media_path=os.path.join(xbmc.translatePath(Addon.getAddonInfo("path")),'resources','media')
...
class TelePlayer(xbmc.Player):
    ...
    def download_file(self):
        try:
            buffer_size_d=int(Addon.getSetting("buffer_size"))
                    ...
                    while True:
                        ...
                        if 'path' in event:
                            ...
                            if file_size!=0:
                                    ...
                                    dp.update(int((file_size*100.0)/buffer_size),str(int(speed/(1024)))+' Kbps / '+str(int(t_remiain))+' sec')
    ...
    def get_resume(self):
        ...
        self.dbcon.close()
        return set_runtime
    def playTeleFile(self, id_pre,data,name,no_subs,tmdb,season,episode,original_title,description,resume,l_data):
      try:
        self.tmdb=tmdb
        ...
        listItem.setArt({'icon': iconimage, 'thumb': fanart, 'poster': iconimage,'tvshow.poster': iconimage, 'season.poster': iconimage})
        ...
        if resume_time!=-1:
            ...
            for _ in range(w_time):
                dp.update(0,Addon.getLocalizedString(32040)+' : '+str(_))
                try:
...
def infiniteReceiver(all_d,last_id,archive='chatListMain',chat_filter_id='0'):
   global exit_now
   try:
    ...
    if chat_filter_id=='0':
        data={'type':'td_send',
             'info':json.dumps({'@type': 'getChats','offset_chat_id':leid,'offset_order':order, 'limit': '100','chat_list':{'@type': archive}, '@extra': num})
             }
    else:
        data={'type':'td_send',
             'info':json.dumps({'@type': 'getChats','offset_chat_id':leid,'offset_order':order, 'limit': '100','chat_list':{'@type': 'chatListFilter','chat_filter_id':int(chat_filter_id)}, '@extra': num})
             }
    event=requests.post('http://127.0.0.1:%s/'%listen_port,json=data).json()
        ...
        for items in j_enent_o['chat_ids']:
            ...
            if j_enent['@type']=='chat' and len(j_enent['title'])>1:
                ...
                if 'last_message' in j_enent:
                    ...
                    plot=name
                dp.update(int(((zzz* 100.0)/(len(j_enent_o['chat_ids']))) ), name )
                zzz+=1
    ...
    if items!='':
        ...
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32026)+'[/B][/COLOR]',archive,12,'https://sitechecker.pro/wp-content/uploads/2017/12/search-engines.png','https://www.komando.com/wp-content/uploads/2017/12/computer-search.jpg','Next',data='all',last_id=last_id)
        all_d.append(aa)
    ...
    return all_d
        ...
        logging.warning(str(e))
        xbmcgui.Dialog().ok('Error occurred','Err:'+str(e)+'Line:'+str(lineno))
def my_groups(last_id,url,groups_id):
    ...
    try:
        ...
        all_d.append(aa)
        all_d=infiniteReceiver(all_d,last_id,archive=url,chat_filter_id=groups_id)
...
def main_menu():
    ...
    if event['status']==2 or event['status']=='Needs to log from setting':
        ...
        all_d.append(aa)
        #Tv Shows
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32021)+'[/B][/COLOR]',str(id),11,'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ48ZyMr013iwx2gXtSBm9iAcSkxv5ue5eJ16DEPXLCckXGcVRa','https://www.fanthatracks.com/wp-content/uploads/2019/08/themandalorian_disneyplus_SM_poster_cover.jpg','Tv Shows')
        all_d.append(aa)
        ...
        #Movies
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32020)+'[/B][/COLOR]',str(id),10,'special://home/addons/plugin.video.telemedia19/tele/movies.png','https://www.ubackground.com/_ph/22/269562231.jpg','Movies')
        all_d.append(aa)
        #Tv Shows
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32021)+'[/B][/COLOR]',str(id),11,'special://home/addons/plugin.video.telemedia19/tele/tvshows.png','https://static.highsnobiety.com/thumbor/R8JPAdy4hlfFhZj9_YqCQfcNsZ0=/fit-in/800x480/smart/static.highsnobiety.com/wp-content/uploads/2019/02/28155224/game-of-thrones-season-8-posters-001.jpg','Tv Shows')
        all_d.append(aa)
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32073)+'[/B][/COLOR]','www',31,'special://home/addons/plugin.video.telemedia19/tele/kids.png','https://insidethemagic-119e2.kxcdn.com/wp-content/uploads/2018/08/Expo19_11x16_Poster_KeyArt_72dpi-1-792x400.jpg',Addon.getLocalizedString(32073),data=KIDS_CHAT_ID)
        all_d.append(aa)
        #My Groups
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32022)+'[/B][/COLOR]','chatListMain',12,'special://home/addons/plugin.video.telemedia19/tele/mygroups.png','https://wallup.net/wp-content/uploads/2016/10/12/137743-jumping-silhouette-group_of_people-cat-sea-reflection.jpg','My Groups',last_id='0$$$9223372036854775807')
        all_d.append(aa)
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32138)+'[/B][/COLOR]','chatListArchive',12,'special://home/addons/plugin.video.telemedia19/tele/archive.png','https://hdwallpaperim.com/wp-content/uploads/2017/08/23/471244-Brandon_Sanderson-Stormlight_Archives.jpg','My Groups',last_id='0$$$9223372036854775807')
        all_d.append(aa)
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32141)+'[/B][/COLOR]','chatListArchive',121,'special://home/addons/plugin.video.telemedia19/tele/folder.png','https://cirasync.com/wp-content/uploads/2019/07/Create-and-Share-PF-O365_featuredimage95-1-1080x630.png','My Folders')
        all_d.append(aa)
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32027)+'[/B][/COLOR]',str(id),113,'special://home/addons/plugin.video.telemedia19/tele/search.png','https://seleritysas.com/wp-content/uploads/2019/12/shutterstock_606583169.jpg','Search All',last_id='0$$$0',data='all')
        all_d.append(aa)
        # #Search Groups
        ...
        if len(Addon.getSetting("update_chat_id"))>0:
            #my repo
            aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32127)+'[/B][/COLOR]','www',46,'special://home/addons/plugin.video.telemedia19/tele/addons.png','https://cdn.wallpapersafari.com/21/48/cRMEy3.jpg',Addon.getLocalizedString(32127))
            all_d.append(aa)
        ...
        if len(match)==0:
          ...
          #all_d.append(aa)
        #Full data groups
        aa=addDir3('[COLOR gold]'+Addon.getLocalizedString(32079)+'[/COLOR]','www',33,'special://home/addons/plugin.video.telemedia19/tele/info.png','https://img.wonderhowto.com/img/66/20/63525837196216/0/hack-like-pro-pivot-from-victim-system-own-every-computer-network.1280x600.jpg',Addon.getLocalizedString(32079))
        all_d.append(aa)
        #Kids World
        aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32073)+'[/B][/COLOR]','www',31,'special://home/addons/plugin.video.telemedia19/tele/kids.png','https://insidethemagic-119e2.kxcdn.com/wp-content/uploads/2018/08/Expo19_11x16_Poster_KeyArt_72dpi-1-792x400.jpg',Addon.getLocalizedString(32073),data=KIDS_CHAT_ID)
        #all_d.append(aa)
        ...
        addNolink( '[COLOR lightblue][B]%s[/B][/COLOR]'%Addon.getLocalizedString(32124), 'www',45,False,iconimage='special://home/addons/plugin.video.telemedia19/tele/addons.png',fan='https://cdn.wallpapersafari.com/21/48/cRMEy3.jpg')
    addNolink( '[COLOR red][B]%s[/B][/COLOR]'%Addon.getLocalizedString(32140), 'www',120,False,fan="https://media-cdn.tripadvisor.com/media/photo-s/08/6f/12/05/beautiful-settings.jpg", iconimage="special://home/addons/plugin.video.telemedia19/tele/setting.png")
def res_q(quality):
    f_q=' '
...
def file_list(id,page,last_id_all,quary,icon_pre,fan_pre,image_master='',original_title=''):
   try:
        ...
        if dont_s_again:
            f_last_id='0$$$0$$$0$$$0'
            #'Search'
            aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32027)+'[/B][/COLOR]',str(id),2,'https://sitechecker.pro/wp-content/uploads/2017/12/search-engines.png','https://www.komando.com/wp-content/uploads/2017/12/computer-search.jpg','search',data='0',last_id=f_last_id,image_master=image_master)
            all_d.append(aa)
        xbmcplugin .addDirectoryItems(int(sys.argv[1]),all_d,len(all_d))
   except Exception as e:
        import linecache
...
def play(name,url,data,iconimage,fan,no_subs,tmdb,season,episode,original_title,description,resume):
    '''
        ...
        if 0:
            ...
            if (total_free<1600):
                ...
                if (total_free<1600):
                    ...
                    #sys.exit()
        monitor=TelePlayer()
        broken_play,resume_time=monitor.playTeleFile(url,data,name,no_subs,tmdb,season,episode,original_title,description,resume,l_data)
...
def getPublicStream(url):
        ...
        handlers = [
            urllib.HTTPHandler(),
            urllib.HTTPSHandler(),
            urllib.HTTPCookieProcessor(cookies)
            ]
...
def movies_menu():
    all_d=[]
    aa=addDir3(Addon.getLocalizedString(32131),'http://api.themoviedb.org/3/movie/now_playing?api_key=34142515d9d23817496eeb4ff1d223d0&language=%s&page=1'%lang,14,'special://home/addons/plugin.video.telemedia19/tele/Movies/cinema.png','https://images.cdn1.stockunlimited.net/preview1300/cinema-background-with-movie-objects_1823387.jpg','Tmdb')
    all_d.append(aa)
    'Popular Movies'
    aa=addDir3(Addon.getLocalizedString(32047),'http://api.themoviedb.org/3/movie/popular?api_key=34142515d9d23817496eeb4ff1d223d0&language=%s&page=1'%lang,14,'special://home/addons/plugin.video.telemedia19/tele/Movies/popular.png','https://www.newszii.com/wp-content/uploads/2018/08/Most-Popular-Action-Movies.png','Tmdb')
    all_d.append(aa)

    #Genre
    aa=addDir3(Addon.getLocalizedString(32048),'http://api.themoviedb.org/3/genre/movie/list?api_key=34142515d9d23817496eeb4ff1d223d0&language=%s&page=1'%lang,18,'special://home/addons/plugin.video.telemedia19/tele/Movies/genre.png','https://s.studiobinder.com/wp-content/uploads/2019/09/Movie-Genres-Types-of-Movies-List-of-Genres-and-Categories-Header-StudioBinder.jpg','Tmdb')
    all_d.append(aa)
    #Years
    aa=addDir3(Addon.getLocalizedString(32049),'movie_years&page=1',14,'special://home/addons/plugin.video.telemedia19/tele/Movies/years.png','https://i.pinimg.com/originals/e4/03/91/e4039182cd17c48c8f9cead44cda7df3.jpg','Tmdb')
    all_d.append(aa)
    aa=addDir3(Addon.getLocalizedString(32132),'movie_years&page=1',112,'special://home/addons/plugin.video.telemedia19/tele/Movies/studio.png','https://cdn-static.denofgeek.com/sites/denofgeek/files/styles/main_wide/public/2016/04/movlic_studios_1.jpg?itok=ih8Z7wOk','Tmdb')
    all_d.append(aa)
    #movie World
    aa=addDir3('[COLOR lime]'+Addon.getLocalizedString(32074)+'[/COLOR]','www',31,'special://home/addons/plugin.video.telemedia19/tele/Movies/movie_world.png','https://cdn.hipwallpaper.com/i/14/59/G8mUMK.jpg',Addon.getLocalizedString(32074),data=-1001000750206)
    all_d.append(aa)
    
    #ISRAEL NOVIES
    aa=addDir3('[COLOR pink]'+Addon.getLocalizedString(32075)+'[/COLOR]','www',31,'special://home/addons/plugin.video.telemedia19/tele/Movies/israel.png','https://i.ytimg.com/vi/Hq0CZUvuSDs/maxresdefault.jpg',Addon.getLocalizedString(32075),data=HEBREW_GROUP)
    all_d.append(aa)
    #Search movie
    aa=addDir3(Addon.getLocalizedString(32070),'http://api.themoviedb.org/3/search/movie?api_key=34142515d9d23817496eeb4ff1d223d0&query=%s&language=he&append_to_response=origin_country&page=1',14,'special://home/addons/plugin.video.telemedia19/tele/Movies/movie_search.png','http://www.videomotion.co.il/wp-content/uploads/whatwedo-Pic-small.jpg','Tmdb')
    all_d.append(aa)
...
def tv_show_menu():
    ...
    #Popular
    aa=addDir3(Addon.getLocalizedString(32057),'http://api.themoviedb.org/3/tv/popular?api_key=34142515d9d23817496eeb4ff1d223d0&language=%s&page=1'%lang,14,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/popular_tv.png','https://image.businessinsider.com/5d5ea69fcd97841fea3d3b36?width=1100&format=jpeg&auto=webp','TMDB')
    all.append(aa)
    aa=addDir3(Addon.getLocalizedString(32133),'https://api.themoviedb.org/3/tv/on_the_air?api_key=34142515d9d23817496eeb4ff1d223d0&language=%s&page=1'%lang,14,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/on_air.png','https://i.pinimg.com/236x/1c/49/8f/1c498f196ef8818d3d01223b72678fc4--divergent-movie-poster-divergent-.jpg','TMDB')
    all.append(aa)
    #Genre
    aa=addDir3(Addon.getLocalizedString(32048),'http://api.themoviedb.org/3/genre/tv/list?api_key=34142515d9d23817496eeb4ff1d223d0&language=%s&page=1'%lang,18,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/genre.png','https://consequenceofsound.net/wp-content/uploads/2019/11/CoS_2010sDecades-TVShows.jpg?quality=80','TMDB')
    all.append(aa)
	#New_Tv_Shows
	...
	'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/new_tv.png',
	'https://lh5.ggpht.com/cr6L4oleXlecZQBbM1EfxtGggxpRK0Q1cQ8JBtLjJdeUrqDnXAeBHU30trRRnMUFfSo=w300','TMDB')
    all.append(aa)	
    #Years
    aa=addDir3(Addon.getLocalizedString(32049),'tv_years&page=1',14,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/years.png','https://d2yhzr6tx8qnba.cloudfront.net/images/db/9/b6/58e2db43d1b69.jpeg','TMDB')
    all.append(aa)
    aa=addDir3(Addon.getLocalizedString(32134),'tv_years&page=1',101,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/network.png','https://images.pond5.com/tv-networks-logos-loop-footage-042898083_prevstill.jpeg','TMDB')
    all.append(aa)
    aa=addDir3(Addon.getLocalizedString(32135),'https://api.themoviedb.org/3/discover/tv?api_key=34142515d9d23817496eeb4ff1d223d0&language={0}&sort_by=popularity.desc&include_null_first_air_dates=false&with_original_language={1}&page=1'.format(lang,lang),14,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/israel.png','http://coldshotproductions.net/flachannelbanner.png',Addon.getLocalizedString(32135))
    all.append(aa)
    #Add Turkish Tv shows
    aa=addDir3(Addon.getLocalizedString(32101),'https://api.themoviedb.org/3/discover/tv?api_key=34142515d9d23817496eeb4ff1d223d0&language={0}&sort_by=popularity.desc&include_null_first_air_dates=false&with_original_language={1}&page=1'.format(lang,'tr'),14,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/turkish.png','http://coldshotproductions.net/flachannelbanner.png',Addon.getLocalizedString(32046))
    all.append(aa)
    aa=addDir3(Addon.getLocalizedString(32136),'https://api.themoviedb.org/3/discover/tv?api_key=34142515d9d23817496eeb4ff1d223d0&language={0}&sort_by=popularity.desc&include_null_first_air_dates=false&with_original_language={1}&page=1'.format(lang,'tr'),114,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/my_tv.png','http://mjdtech.net/content/images/2016/02/traktfeat.jpg',Addon.getLocalizedString(32046))
    #all.append(aa)
    aa=addDir3(Addon.getLocalizedString(32055),'www',28,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/my_tv.png','http://coldshotproductions.net/flachannelbanner.png',Addon.getLocalizedString(32055))
    all.append(aa)
    #Search tv
    aa=addDir3(Addon.getLocalizedString(32071),'http://api.themoviedb.org/3/search/tv?api_key=34142515d9d23817496eeb4ff1d223d0&query=%s&language=he&page=1',14,'special://home/addons/plugin.video.telemedia19/tele/Tv_Show/search.png','http://f.frogi.co.il/news/640x300/010170efc8f.jpg','TMDB')
    all.append(aa)
...
def tmdb_world(last_id,icon,fan,chan_id):
    ...
    f_last_id='0$$$0$$$0$$$0'
    #'Search'
    aa=addDir3('[B][COLOR gold]'+Addon.getLocalizedString(32027)+'[/B][/COLOR]',str(chan_id),2,'https://sitechecker.pro/wp-content/uploads/2017/12/search-engines.png','https://www.komando.com/wp-content/uploads/2017/12/computer-search.jpg','search',data='0',last_id=f_last_id,image_master=icon_pre+'$$$'+fan_pre)
    all_d.append(aa)
    xbmcplugin .addDirectoryItems(int(sys.argv[1]),all_d,len(all_d))
...
def groups_join(id,icon_pre,fan_pre):
    ...
    m_id=0
    count=0
    logging.warning('Get All groups')
    all_d=[]
    all_l=[]
    while count<10:
        count+=1
        logging.warning('m_id')
        logging.warning(m_id)
        data={'type':'td_send',
...
def play_remote(url,season,episode,original_title,id,saved_name,description,resume,name,heb_name,c_id=None,m_id=None):
    ...
    if found:
        ...
        play(name,json.dumps(link_data),'','','','0',id,season,episode,original_title,description,resume)
    return 0
...
try:        
        ...
        pass
try:        
        heb_name= urllib.parse.unquote_plus(params["heb_name"])
except:
        pass
try:        
        isr=int(params["isr"])
...
try:        
        ...
        pass
try:        
        image_master= urllib.parse.unquote_plus(params["image_master"])
except:
        pass
try:        
        last_id= urllib.parse.unquote_plus(params["last_id"])
except:
        pass
try:        
...
if (mode==None or url==None or len(url)<1) and len(sys.argv)>1:
    ...
    my_groups(last_id,url,groups_id)
elif mode==13:
