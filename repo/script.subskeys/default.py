...
class MyAddon(pyxbmct.AddonDialogWindow):
    ...
    def setbutton(self,value,type):
      ...
      if choise==True:
        ...
        if type=='next':
          ...
          location=findItem(userkeymap,'XBMC.ActivateWindow(SubtitleSearch)')

          for loc in location:
            userkeymap.pop(loc[0])
          userkeymap.append(('global', 'XBMC.ActivateWindow(SubtitleSearch)', newkey))
    ...
    def set_active_controls(self):
        ...
        location_open=findItem(userkeymap,'XBMC.ActivateWindow(SubtitleSearch)')
